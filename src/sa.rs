...
impl SimAnn {
    ...
    pub fn get_cost(&self , cities : &Vec<u16>) -> f64 {
    ...
    fn add_dist( &self , cities : &Vec<u16>) -> f64{
        let mut sum: f64 = 0.0;
    ...
    fn get_neighbor(&mut self, mut cities : Vec<u16>) -> Vec<u16>{
    ...
    fn update_sum(&mut self) {
        ...
        self.fill_distances();
        let n1 : usize = usize::try_from(self.n1).unwrap();
